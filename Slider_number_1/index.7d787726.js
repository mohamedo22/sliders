...
import {c as r, G as s, T as a, R as l, C as c, a as m, P as h, V as p, M as g, b as x, S as d, N as u} from "./vendor.315b6b96.js";
!function() {
...
const f = "float PI = 3.141592653589793238;"
  ...
  , R = (e,t)=>{
    const {shaderPerSlide: n, swiper: o} = t
...
class K {
    ...
    resize() {
        if (!this.initialized || this.destroyed)
            return;
        const {width: e, height: t} = this.swiper;
        this.width = e,
        this.height = t,
        ...
        this.material.uniforms.resolution.value.y = t,
        ...
        this.vertexMaterial.uniforms.resolution.value.y = t,
    ...
    addObjects() {
        ...
        this.shader.vertex) {
            ...
            this.vertexMaterial.uniforms.texture1.value = t,
    ...
    replaceShader(e) {
        let t, n;
        this.shader.vertex ? (t = this.material.uniforms.texture1.value,
        n = this.vertexMaterial.uniforms.texture1.value) : (t = this.material.uniforms.texture1.value,
        n = this.material.uniforms.texture2.value);
        ...
        this.uniforms = r || {},
        this.addObjects(),
        this.shader.vertex ? (this.material.uniforms.texture1.value = n,
        this.vertexMaterial.uniforms.texture1.value = n) : (this.material.uniforms.texture1.value = t,
        this.material.uniforms.texture2.value = n,
    ...
    replaceRandomShader() {
        const e = R(this.opts.shader, this.opts)
          , {fragment: t, uniforms: n, vertex: o} = e;
        this.shader = e,
        this.fragment = t || "",
        this.uniforms = n || {},
        this.vertex = o || C,
    ...
    setProgress(e, t, n, o, i) {
        ...
        this.swiper.params.loop && this.swiper.slides[e] && this.swiper.slides[t] && (e = parseInt(this.swiper.slides[e].getAttribute("data-swiper-slide-index"), 10),
        t = parseInt(this.swiper.slides[t].getAttribute("data-swiper-slide-index"), 10));
        const r = this.textures[t]
          , s = this.textures[e];
        if (this.material.uniforms.texture1.value = s,
        this.shader.vertex ? this.vertexMaterial.uniforms.texture1.value = r : this.material.uniforms.texture2.value = r,
        i) {
            if (this.preventShaderReplace)
                return void (this.material.uniforms.progress.value = Math.abs(n));
            ...
            this.material.uniforms.texture2.value = r,
            this.material.uniforms.progress.value = Math.abs(n)) : this.material.uniforms.progress.value = Math.abs(n)
        } else
            o ? (0 === n && 0 === this.material.uniforms.progress.value && (this.material.uniforms.progress.value = 1),
            1 === n && 1 === this.material.uniforms.progress.value && (this.material.uniforms.progress.value = 0),
            this.animateUniform(this.material.uniforms.progress, n, (()=>{
                ("random" === this.swiper.params.gl.shader || Array.isArray(this.swiper.params.gl.shader)) && (this.replaceRandomShader(),
                this.material.uniforms.texture1.value = s,
                this.material.uniforms.texture2.value = r,
                this.material.uniforms.progress.value = n),
                1 === n && (this.material.uniforms.texture1.value = r),
...
const Y = new d(".swiper",{
    modules: [u, function({swiper: e, on: t, extendParams: n}) {
        e.gl = null;
        let o = !1;
        n({
            gl: {
        ...
        t("init", (()=>{
            "gl" !== e.params.effect || o || e.glDestroyed || e.gl || i()
        }
        )),
        t("resize", (()=>{
            "gl" !== e.params.effect || o || e.glDestroyed || e.gl.resize()
        }
        )),
        t("setTranslate", (()=>{
            if ("gl" !== e.params.effect || o || e.glDestroyed)
                return;
            let t, n, a;
            e.gl || i();
            let l = !1;
            e.slides.forEach(((o,i)=>{
                const r = o.progress;
                e.params.cssMode && 0 === Math.round(100 * r) && (l = !0),
                (r > 0 && r < 1 || 0 === r && e.progress < s) && (t = i,
                n = i + 1,
                a = r),
                (r < 0 && r > -1 || 0 === r && e.progress > s) && (t = i - 1,
                n = i,
                a = 1 + r)
            }
            )),
            s = e.progress || 0,
            void 0 === t && void 0 === n || (l = l && Math.round(a) === a,
            e.gl.setProgress(t, n, a, r, l))
        }
        )),
        t("setTransition", ((t,n)=>{
            "gl" !== e.params.effect || o || e.glDestroyed || (r = n > 0 && !e.params.cssMode)
        }
        )),
        t("slidesGridLengthChange", (()=>{
            "gl" !== e.params.effect || o || !e.initialized || e.glDestroyed || e.gl && e.gl.loadTextures && e.gl.loadTextures()
        }
        )),
        t("beforeDestroy", (()=>{
            "gl" !== e.params.effect || o || e.gl && (e.glDestroyed = !0,
            e.gl.destroy(),
            e.gl = null)
        }
        ))
...
T.addEventListener("click", (e=>{
    var t;
    "SPAN" === e.target.nodeName && (t = e.target.textContent.trim(),
    document.querySelector(".demo-shader-current").textContent = t,
    Y.gl.replaceShader(t),
