...
function V(e) {
    ...
    let o = i.target;
    if ("wrapper" === r.touchEventsTarget && !t.wrapperEl.contains(o))
        return;
    ...
    let w = !0;
    o.matches(a.focusableElements) && (w = !1,
    "SELECT" === o.nodeName && (a.isTouched = !1)),
...
function H(e) {
    ...
    a.oneWayMovement && (h = Math.abs(h) * (n ? 1 : -1),
    v = Math.abs(v) * (n ? 1 : -1)),
    r.diff = h,
    h *= a.touchRatio,
    n && (h = -h,
    ...
    if ((new Date).getTime(),
    i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b && y && Math.abs(h) >= 1)
    ...
    let S = !0
      , T = a.resistanceRatio;
    if (a.touchReleaseOnEdges && (T = 0),
    h > 0 ? (b && y && i.allowThresholdMove && i.currentTranslate > (a.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    i.currentTranslate > s.minTranslate() && (S = !1,
    a.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + h) ** T))) : h < 0 && (b && y && i.allowThresholdMove && i.currentTranslate < (a.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
        direction: "next",
        setTranslate: !0,
    ...
    a.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - h) ** T))),
...
function j(e) {
    ...
    if (t.allowClick) {
        ...
        t.emit("tap click", a),
        p < 300 && c - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", a)
    }
    ...
    s.isMoved = !1,
    s.startMoving = !1,
    u = r.followFinger ? l ? t.translate : -t.translate : -s.currentTranslate,
    r.cssMode)
        return;
    ...
    for (let h = 0; h < o.length; h += h < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
        ...
        void 0 !== o[h + e] ? u >= o[h] && u < o[h + e] && (m = h,
        f = o[h + e] - o[h]) : u >= o[h] && (m = h,
    ...
    update: {
        ...
        updateSlides: function() {
            ...
            for (let S = 0; S < p; S += 1) {
                ...
                if (P = 0,
                c[S] && (i = c[S]),
                C && e.grid.updateSlide(S, i, c),
                !c[S] || "none" !== M(i, "display")) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        P = (r - (s.slidesPerView - 1) * b) / s.slidesPerView,
                        s.roundLengths && (P = Math.floor(P)),
                        c[S] && (c[S].style[e.getDirectionLabel("width")] = `${P}px`);
                    c[S] && (c[S].swiperSlideSize = P),
                    f.push(P),
                    s.centeredSlides ? (y = y + P / 2 + T / 2 + b,
                    0 === T && 0 !== S && (y = y - r / 2 - b),
                    0 === S && (y = y - r / 2 - b),
                    Math.abs(y) < .001 && (y = 0),
            ...
            s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                ...
                S(i, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
    ...
    slide: {
        slideTo: function(e, t, s, i, a) {
            ...
            if (r.initialized && n !== p) {
                if (!r.allowSlideNext && (u ? v > r.translate && v > r.minTranslate() : v < r.translate && v < r.minTranslate()))
                    return !1;
    ...
    loop: {
        ...
        loopFix: function(e) {
            ...
            const k = y ? Math.ceil(p.length / h.grid.rows) : p.length
              , I = (y ? p[r].column : r) + (g && void 0 === a ? -v / 2 + .5 : 0);
            if (I < b) {
                P = Math.max(b - I, w);
            ...
            c.recalcSlides(),
            "auto" === h.slidesPerView ? c.updateSlides() : y && (S.length > 0 && M || T.length > 0 && C) && c.slides.forEach(((e,t)=>{
            ...
            s)
                if (S.length > 0 && M) {
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(E + P, 0, !1, !0),
                        a && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t,
                    ...
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(E - L, 0, !1, !0),
                        a && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t,
                        c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                    } else {
...
class te {
    ...
    mount(e) {
        ...
        return !a && t.params.createElements && (a = C("div", t.params.wrapperClass),
        s.append(a),
...
function ne(e) {
    ...
    const S = ()=>{
      ...
      , C = (e,s)=>{
        ...
        const a = ()=>{
            n("autoplayPause"),
            i.params.autoplay.waitForTransition ? i.wrapperEl.addEventListener("transitionend", y) : M()
        }
        ;
        if (i.autoplay.paused = !0,
        s)
            return f && (o = i.params.autoplay.delay),
            f = !1,
            void a();
        const r = o || i.params.autoplay.delay;
        o = r - ((new Date).getTime() - b),
        i.isEnd && o < 0 && !i.params.loop || (o < 0 && (o = 0),
        a())
    }
      , M = ()=>{
      ...
      , L = e=>{
        ...
        g = !0,
        i.animating || i.autoplay.paused || C(!0))
    }
      , k = e=>{
    ...
    r("init", (()=>{
        ...
        i.el.addEventListener("pointerleave", k)),
        u().addEventListener("visibilitychange", P),
        E())
    }
    )),
    r("destroy", (()=>{
        ...
        u().removeEventListener("visibilitychange", P),
...
te.use([function(e) {
    ...
    s("init", (()=>{
        ...
        r.observe(t.el)) : (a.addEventListener("resize", l),
