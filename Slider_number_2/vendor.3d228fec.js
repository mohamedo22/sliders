    ...
    for (let s = 1; s < arguments.length; s += 1) {
        ...
        if (null != i && !T(i)) {
            ...
            for (let t = 0, r = s.length; t < r; t += 1) {
                ...
                void 0 !== n && n.enumerable && (w(e[r]) && w(i[r]) ? i[r].__swiper__ ? e[r] = i[r] : S(e[r], i[r]) : !w(e[r]) && w(i[r]) ? (e[r] = {},
...
function z(e) {
    ...
    A || (A = function(e) {
        ...
        const p = n.match(/(iPod)(.*OS\s([\d_]+))?/)
          ...
          , f = "Win32" === r;
        let m = "MacIntel" === r;
        return !c && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/),
        c || (c = [0, 1, "13_0_0"]),
        m = !1),
        d && !f && (a.os = "android",
        a.android = !0),
...
function B(e) {
    ...
    !n.touchStartForcePreventDefault && !T || l.isContentEditable || i.preventDefault(),
...
function $(e) {
    ...
    if ((new Date).getTime(),
    i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && T && S && Math.abs(m) >= 1)
    ...
    m > 0 ? (T && S && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    i.currentTranslate > s.minTranslate() && (b = !1,
    r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** x))) : m < 0 && (T && S && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
        direction: "next",
        setTranslate: !0,
        activeSlideIndex: s.slides.length - ("auto" === r.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
    }),
    i.currentTranslate < s.maxTranslate() && (b = !1,
    r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - m) ** x))),
...
function j(e) {
    ...
    for (let m = 0; m < l.length; m += m < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
        const e = m < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
        void 0 !== l[m + e] ? u >= l[m] && u < l[m + e] && (f = m,
        h = l[m + e] - l[m]) : u >= l[m] && (f = m,
    ...
    if (p > n.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (T >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? g : f + S) : t.slideTo(f)),
        "prev" === t.swipeDirection && (T > 1 - n.longSwipesRatio ? t.slideTo(f + S) : null !== w && T < 0 && Math.abs(T) > n.longSwipesRatio ? t.slideTo(w) : t.slideTo(f))
    } else {
        if (!n.shortSwipes)
            return void t.slideTo(t.activeIndex);
        t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(f + S) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : f + S),
...
const X = (e,t)=>{
    ...
    i.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", H, !0) : e[d]("observerUpdate", H, !0),
    r[l]("load", e.onLoad, {
        capture: !0
    })
}
...
const Q = {
    ...
    update: {
        ...
        updateSlides: function() {
            ...
            s.centeredSlides && s.cssMode && (b(i, "--swiper-centered-offset-before", ""),
            ...
            for (let b = 0; b < p; b += 1) {
                ...
                !c[b] || "none" !== P(i, "display")) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        C = (n - (s.slidesPerView - 1) * T) / s.slidesPerView,
                        s.roundLengths && (C = Math.floor(C)),
                        c[b] && (c[b].style[e.getDirectionLabel("width")] = `${C}px`);
                    c[b] && (c[b].swiperSlideSize = C),
                    h.push(C),
                    s.centeredSlides ? (S = S + C / 2 + x / 2 + T,
                    0 === x && 0 !== b && (S = S - n / 2 - T),
                    0 === b && (S = S - n / 2 - T),
                    Math.abs(S) < .001 && (S = 0),
            ...
            a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize + T}px`),
            ...
            s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                ...
                b(i, "--swiper-centered-offset-after", e.size / 2 - h[h.length - 1] / 2 + "px");
        ...
        updateSlidesClasses: function() {
            ...
            a ? (c && c.classList.add(s.slideNextClass),
    ...
    slide: {
        slideTo: function(e, t, s, i, r) {
            ...
            let a = e;
            a < 0 && (a = 0);
            const {params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: f, enabled: h} = n;
            ...
            if (o.normalizeSlideIndex)
                for (let T = 0; T < d.length; T += 1) {
                    ...
                    void 0 !== d[T + 1] ? e >= t && e < s - (s - t) / 2 ? a = T : e >= t && e < s && (a = T + 1) : e >= t && (a = T)
                }
            if (n.initialized && a !== p) {
                if (!n.allowSlideNext && (u ? g > n.translate && g > n.minTranslate() : g < n.translate && g < n.minTranslate()))
                    return !1;
                if (!n.allowSlidePrev && g > n.translate && g > n.maxTranslate() && (p || 0) !== a)
                    return !1
            }
            let w;
            if (a !== (c || 0) && s && n.emit("beforeSlideChangeStart"),
            n.updateProgress(g),
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                n = e.getSlideIndex(y(s, `${a}[data-swiper-slide-index="${r}"]`)[0]),
                m((()=>{
                    e.slideTo(n)
                }
    ...
    loop: {
        ...
        loopFix: function(e) {
            ...
            const {slides: p, allowSlidePrev: u, allowSlideNext: f, slidesEl: h, params: m} = c
              , {centeredSlides: v} = m;
            ...
            p.length < g + T ? E("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === m.grid.fill && E("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const b = []
              , x = [];
            let y = c.activeIndex;
            void 0 === n ? n = c.getSlideIndex(p.filter((e=>e.classList.contains(m.slideActiveClass)))[0]) : y = n;
            const M = "next" === i || !i
              , P = "prev" === i || !i;
            let C = 0
              , I = 0;
            const L = S ? Math.ceil(p.length / m.grid.rows) : p.length
              , A = (S ? p[n].column : n) + (v && void 0 === r ? -g / 2 + .5 : 0);
            if (A < T) {
                C = Math.max(T - A, w);
                for (let e = 0; e < T - A; e += 1) {
            ...
            c.recalcSlides(),
            "auto" === m.slidesPerView ? c.updateSlides() : S && (b.length > 0 && P || x.length > 0 && M) && c.slides.forEach(((e,t)=>{
            ...
            s)
                if (b.length > 0 && P) {
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(y + C, 0, !1, !0),
                        ...
                        const e = S ? b.length / m.grid.rows : b.length;
                    ...
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(y - I, 0, !1, !0),
                        r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t,
                        c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                    } else {
                        const e = S ? x.length / m.grid.rows : x.length;
                        c.slideTo(c.activeIndex - e, 0, !1, !0)
                    }
    ...
    const r = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]"
      ...
      , a = ()=>{
        const {el: e, slides: s, progress: i, snapGrid: a, isElement: o} = t
          , l = y(e, r);
        t.isElement && l.push(...y(t.hostEl, r)),
        l.forEach((e=>{
            n(e, i)
        }
        )),
        s.forEach(((e,s)=>{
            let o = e.progress;
            t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (o += Math.ceil(s / 2) - i * (a.length - 1)),
        ...
        setTranslate: function(e, s) {
            ...
            if (Array.isArray(i))
                for (let t = 0; t < i.length; t += 1)
                    i[t] !== s && i[t]instanceof o && l(i[t]);
            else
                i instanceof o && s !== i && l(i)
        },
...
export {se as C, te as P, ee as S};
