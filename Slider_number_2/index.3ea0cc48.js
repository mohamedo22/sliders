var e = Object.defineProperty
  ...
  , c = (e,t)=>r(e, o(t));
import {S as d, C as p, P as a} from "./vendor.3d228fec.js";
!function() {
...
!function(e) {
    const r = e.querySelector(".swiper")
      , o = r.cloneNode(!0);
    o.classList.add("triple-slider-prev"),
    e.insertBefore(o, r);
    const t = o.querySelectorAll(".swiper-slide")
      , l = t[t.length - 1];
    o.querySelector(".swiper-wrapper").insertBefore(l, t[0]);
    const s = r.cloneNode(!0);
    s.classList.add("triple-slider-next"),
    e.appendChild(s);
    const i = s.querySelectorAll(".swiper-slide")[0];
    s.querySelector(".swiper-wrapper").appendChild(i),
    r.classList.add("triple-slider-main");
    const u = {
        modules: [p, a],
        speed: 600,
        loop: !0,
