...
function G(e) {
    ...
    A || (A = function(e) {
        ...
        const p = a.match(/(iPod)(.*OS\s([\d_]+))?/)
          ...
          , f = "Win32" === r;
        let h = "MacIntel" === r;
        return !c && h && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = a.match(/(Version)\/([\d.]+)/),
        c || (c = [0, 1, "13_0_0"]),
        h = !1),
        d && !f && (n.os = "android",
        n.android = !0),
...
function j(e) {
    ...
    if (void 0 === i.isScrolling) {
        let e;
        s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : f * f + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI,
    ...
    if ((new Date).getTime(),
    i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b && S && Math.abs(h) >= 1)
    ...
    h > 0 ? (b && S && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    i.currentTranslate > s.minTranslate() && (T = !1,
    r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + h) ** y))) : h < 0 && (b && S && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
        direction: "next",
        setTranslate: !0,
        activeSlideIndex: s.slides.length - ("auto" === r.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
    }),
    i.currentTranslate < s.maxTranslate() && (T = !1,
    r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - h) ** y))),
...
function R(e) {
    ...
    for (let h = 0; h < o.length; h += h < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
        const e = h < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
        void 0 !== o[h + e] ? u >= o[h] && u < o[h + e] && (f = h,
    ...
    if (p > a.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (b >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? v : f + S) : t.slideTo(f)),
        "prev" === t.swipeDirection && (b > 1 - a.longSwipesRatio ? t.slideTo(f + S) : null !== w && b < 0 && Math.abs(b) > a.longSwipesRatio ? t.slideTo(w) : t.slideTo(f))
    } else {
        if (!a.shortSwipes)
            return void t.slideTo(t.activeIndex);
        t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(f + S) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : f + S),
...
const K = (e,t)=>{
    ...
    i.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", q, !0) : e[d]("observerUpdate", q, !0),
    r[o]("load", e.onLoad, {
        capture: !0
    })
}
...
const ee = {
    ...
    update: {
        updateSize: function() {
            ...
            0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(P(i, "padding-left") || 0, 10) - parseInt(P(i, "padding-right") || 0, 10),
            s = s - parseInt(P(i, "padding-top") || 0, 10) - parseInt(P(i, "padding-bottom") || 0, 10),
            Number.isNaN(t) && (t = 0),
            Number.isNaN(s) && (s = 0),
            Object.assign(e, {
                width: t,
        ...
        updateSlides: function() {
            ...
            for (let T = 0; T < p; T += 1) {
                ...
                !c[T] || "none" !== P(i, "display")) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        s.roundLengths)
                            M = e.isHorizontal() ? k(i, "width", !0) : k(i, "height", !0);
                        else {
                            const e = t(r, "width")
                              , s = t(r, "padding-left")
                              , a = t(r, "padding-right")
                        ...
                        M = (a - (s.slidesPerView - 1) * b) / s.slidesPerView,
                        s.roundLengths && (M = Math.floor(M)),
                        c[T] && (c[T].style[e.getDirectionLabel("width")] = `${M}px`);
                    c[T] && (c[T].swiperSlideSize = M),
                    m.push(M),
                    s.centeredSlides ? (S = S + M / 2 + y / 2 + b,
                    0 === y && 0 !== T && (S = S - a / 2 - b),
                    0 === T && (S = S - a / 2 - b),
                    Math.abs(S) < .001 && (S = 0),
                    s.roundLengths && (S = Math.floor(S)),
                    x % s.slidesPerGroup == 0 && u.push(S),
                    f.push(S)) : (s.roundLengths && (S = Math.floor(S)),
            ...
            s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                ...
                T(i, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
    ...
    slide: {
        slideTo: function(e, t, s, i, r) {
            ...
            let n = e;
            n < 0 && (n = 0);
            const {params: l, snapGrid: o, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: f, enabled: m} = a;
            if (a.animating && l.preventInteractionOnTransition || !m && !i && !r)
                return !1;
    ...
    loop: {
        loopCreate: function(e) {
            ...
            if (l) {
                if (s.loopAddBlankSlides) {
                    ...
                    C("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                r()
            } else if (o) {
                if (s.loopAddBlankSlides) {
                    ...
                    C("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                r()
            } else
                r();
            t.loopFix({
        ...
        loopFix: function(e) {
            ...
            const {slides: p, allowSlidePrev: u, allowSlideNext: f, slidesEl: m, params: h} = c
              , {centeredSlides: g} = h;
            if (c.allowSlidePrev = !0,
            c.allowSlideNext = !0,
            c.virtual && h.virtual.enabled)
                return s && (h.centeredSlides || 0 !== c.snapIndex ? h.centeredSlides && c.snapIndex < h.slidesPerView ? c.slideTo(c.virtual.slides.length + c.snapIndex, 0, !1, !0) : c.snapIndex === c.snapGrid.length - 1 && c.slideTo(c.virtual.slidesBefore, 0, !1, !0) : c.slideTo(c.virtual.slides.length, 0, !1, !0)),
                c.allowSlidePrev = u,
                c.allowSlideNext = f,
                void c.emit("loopFix");
            ...
            p.length < v + b ? C("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === h.grid.fill && C("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const T = []
              , y = [];
            let x = c.activeIndex;
            void 0 === a ? a = c.getSlideIndex(p.filter((e=>e.classList.contains(h.slideActiveClass)))[0]) : x = a;
            const E = "next" === i || !i
              , M = "prev" === i || !i;
            let P = 0
              , L = 0;
            const I = S ? Math.ceil(p.length / h.grid.rows) : p.length
              , k = (S ? p[a].column : a) + (g && void 0 === r ? -v / 2 + .5 : 0);
            if (k < b) {
                P = Math.max(b - k, w);
            ...
            c.recalcSlides(),
            "auto" === h.slidesPerView ? c.updateSlides() : S && (T.length > 0 && M || y.length > 0 && E) && c.slides.forEach(((e,t)=>{
    ...
    breakpoints: {
        setBreakpoint: function() {
            ...
            s && (u ? (e.loopDestroy(),
            e.loopCreate(t),
            e.updateSlides()) : !f && h ? (e.loopCreate(t),
            e.updateSlides()) : f && !h && e.loopDestroy()),
            e.emit("breakpoint", l)
        },
...
class se {
    ...
    getSlideIndex(e) {
        const {slidesEl: t, params: s} = this
          , i = L(E(t, `.${s.slideClass}, swiper-slide`)[0]);
        return L(e) - i
    }
    ...
    mount(e) {
        ...
        Object.assign(t, {
            ...
            rtlTranslate: "horizontal" === t.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === P(s, "direction")),
...
function re(e) {
    ...
    function u() {
        ...
        p.forEach(((e,a)=>{
            ...
            "custom" === s.type && s.renderCustom ? (e.innerHTML = s.renderCustom(t, i + 1, f),
    ...
    function m() {
        ...
        s.length > 1 && (s = s.filter((e=>I(e, ".swiper")[0] === t.el))[0])),
    ...
    i("init", (()=>{
        !1 === t.params.pagination.enabled ? g() : (m(),
        f(),
        u())
    }
    )),
...
function oe(e) {
    ...
    !function(e) {
        const {effect: t, swiper: s, on: i, setTranslate: r, setTransition: a, overwriteParams: n, perspective: l, recreateShadows: o, getEffectParams: d} = e;
        let c;
        i("beforeInit", (()=>{
        ...
        setTranslate: ()=>{
            ...
            for (let o = 0; o < e.length; o += 1) {
                const s = e[o]
                  , i = s.progress
                  , d = Math.min(Math.max(s.progress, -a.limitProgress), a.limitProgress);
                let c = d;
                l || (c = Math.min(Math.max(s.originalProgress, -a.limitProgress), a.limitProgress));
                ...
                m = !0),
                u.forEach(((e,t)=>{
                    u[t] = `calc(${e}px + (${r(h.translate[t])} * ${Math.abs(d * n)}))`
                }
                )),
                f.forEach(((e,t)=>{
                ...
                T.style.transform = S,
                T.style.opacity = b,
                h.origin && (T.style.transformOrigin = h.origin)
            }
        }
        ,
        setTransition: e=>{
...
export {oe as E, re as P, se as S};
